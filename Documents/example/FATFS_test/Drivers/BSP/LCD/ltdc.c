...
/* 定义LTDC帧缓冲区 */
    ...
    uint32_t g_ltdc_lcd_framebuf[1280][800] __attribute__((section(".bss.ARM.__at_0x70000000")));
 ...
 * @arg     1: 设置失败
 */
static uint8_t ltdc_clk_set(uint32_t pll3r)
{
    ...
    rcc_osc_init_struct.PLL3.PLLR = pll3r;
    ...
    rcc_periph_clk_init_struct.LtdcClockSelection = RCC_LTDCCLKSOURCE_PLL3R;
...
void ltdc_init(void)
{
    ...
    if (id == 0x4342)               /* ATK-MD0430R-480272 */
    {
        ...
        lcdltdc.hfp = 5;            /* 水平前廊 */
        lcdltdc.vfp = 8;            /* 垂直前廊 */
        ltdc_clk_set(128);          /* LTDC_CLK = 9MHz */
    }
    else if (id == 0x7084)          /* ATK-MD0700R-800480 */
    {
        ...
        lcdltdc.vfp = 22;           /* 垂直前廊 */
        ltdc_clk_set(36);           /* LTDC_CLK = 33MHz */
    }
    else if (id == 0x7016)          /* ATK-MD0700R-1024600 */
    {
        ...
        lcdltdc.vfp = 12;           /* 垂直前廊 */
        ltdc_clk_set(30);           /* LTDC_CLK = 40MHz */
    }
    ...
    else if (id == 0x1018)          /* ATK-MD1018R-1280800 */
    {
        ...
        lcdltdc.hfp = 10;           /* 水平前廊 */
        lcdltdc.vfp = 3;            /* 垂直前廊 */
        ltdc_clk_set(26);           /* LTDC_CLK = 45MHz */
    }
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
    ...
    if (hltdc->Instance == LTDC)
    {
        ...
        /* 配置LTDC数据引脚 */
        gpio_init_struct.Pin = GPIO_PIN_5;              /* LTDC_R2 */
        gpio_init_struct.Alternate = GPIO_AF10_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_4;              /* LTDC_R3 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_3;              /* LTDC_R4 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_15;             /* LTDC_R5 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_1;              /* LTDC_R6 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOG, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_0;              /* LTDC_R7 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOG, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_1;              /* LTDC_G2 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_0;              /* LTDC_G3 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_13;             /* LTDC_G4 */
        gpio_init_struct.Alternate = GPIO_AF10_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_12;             /* LTDC_G5 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_11;             /* LTDC_G6 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_10;             /* LTDC_G7 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOB, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_12;             /* LTDC_B2 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_11;             /* LTDC_B3 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_10;             /* LTDC_B4 */
        gpio_init_struct.Alternate = GPIO_AF14_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_9;              /* LTDC_B5 */
        gpio_init_struct.Alternate = GPIO_AF14_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
        gpio_init_struct.Pin = GPIO_PIN_8;              /* LTDC_B6 */
        gpio_init_struct.Alternate = GPIO_AF13_LTDC;
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
