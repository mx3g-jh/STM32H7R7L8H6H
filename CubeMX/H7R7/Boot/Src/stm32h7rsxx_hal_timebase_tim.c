/**
  ...
  * @brief   Template for HAL time base based on the peripheral hardware TIM2.
  *
  *          This file override the native HAL time base functions (defined as weak)
  *          the TIM time base:
  *           + Initializes the TIM2 peripheral to generate a Period elapsed Event each 1ms
...
/**
  ...
  * HAL_TIM2_IRQHandler(). It makes a direct call to HAL_IncTick() to increment
