...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  */
    ...
    PO0     ------> XSPIM_P1_NCS1
    */
    GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_3
                          |GPIO_PIN_0|GPIO_PIN_7|GPIO_PIN_4|GPIO_PIN_6;
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  /* USER CODE END XSPI1_MspDeInit 0 */
    ...
    PO0     ------> XSPIM_P1_NCS1
    */
    HAL_GPIO_DeInit(GPIOP, GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_1|GPIO_PIN_3
                          |GPIO_PIN_0|GPIO_PIN_7|GPIO_PIN_4|GPIO_PIN_6);

    HAL_GPIO_DeInit(GPIOO, GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_0);
